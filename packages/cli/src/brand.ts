...
// `@saas/sdk` client class name (`Ackstack`) is intentionally NOT part of
...
export const CLI_BIN = "ackstack";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Ackstack";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.ackstack.app";
