// `ackstack webhook verify` — local cryptographic verification of a
// Ackstack outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `ackstack login`.
