...
//   - `~/.config/ackstack/credentials.json` (0600)
//   - `~/.config/ackstack/config.json`     (0644)
//
// Override via `ACKSTACK_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/ackstack` everywhere
