 ...
 * signature verifier for Ackstack outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Ackstack webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Ackstack webhook delivery.
 *
