...
//   - AckstackError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Ackstack {
  return new Ackstack({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Ackstack class", () => {
